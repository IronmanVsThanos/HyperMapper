...
cityscapes_root = "/data/DL/code/Rein-train-depth/data/cityscapes/"
cityscapes_crop_size = (880, 882)
cityscapes_train_pipeline = [
    dict(type="LoadImageFromFile"),
    dict(type="LoadAnnotations"),
    dict(type="Resize", scale=(1760, 880)),
...
cityscapes_test_pipeline = [
    dict(type="LoadImageFromFile"),
    dict(type="Resize", scale=(1760, 880), keep_ratio=False),
